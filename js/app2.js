      ...
      <div class="sheet2">
        <div class="col">
          <div class="block">
            ...
            <div class="cgroup">
              <h4>Mobile</h4>
              ${l.mobiles.map((p,i) => `<div class="line"><span class="lab">${i+1}</span><span class="val">${esc(p.n)}</span>${qactPhone(p.n, l.contact, true, true)}</div>`).join("")}
            </div>
            <div class="cgroup">
              <h4>Email</h4>
              ${l.emails.map(p => `<div class="line"><span class="lab"></span><span class="val">${esc(p.n)}</span><div class="qacts"><button title="Email" data-act="email-one" data-n="${esc(p.n)}">${ico("mail",15)}</button></div></div>`).join("")}
              <button class="email-all" data-act="email-all">Email All</button>
            </div>
            <div class="cgroup">
              <h4>Landline</h4>
              ${l.landlines.map((p,i) => `<div class="line"><span class="lab">${i+1}</span><span class="val">${esc(p.n)}</span>${qactPhone(p.n, l.contact, false, false)}</div>`).join("")}
            </div>
          </div>
        </div>
        <div class="col">
